...
class _MemberLoginScreenState extends State<MemberLoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // 🧱 Top Barrier (Hard ceiling for the card)
    final double topBarrierHeight = statusBarHeight + appBarHeight;

    return Scaffold(
      resizeToAvoidBottomInset: false, // 🛑 Keeps push logic smooth
      ...
      body: Stack(
        children: [
            ...
            child: GradientBackground(
              child: Stack(
                ...
                children: [
                  ...
                  // ✅ FOOTER MOVED DOWN & COMPACTED
                  Positioned(
                    bottom: 20, // 👇 Moved closer to bottom (was 30)
                    left: 0,
                    right: 0,
                    child: Column(
                      ...
                      children: [
                        TextButton(
                          onPressed: () {},
                          // 👇 Removes default button padding to bring it closer to icons
          ...
          // ============================================
          // LAYER 2: INTERACTIVE UI (Push Logic)
          // ============================================
          Column(
            children: [
              ...
              Expanded(
                child: Align(
                  alignment: const Alignment(0.0, -0.2), // Position you liked
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // ✅ Error text below both +91 and input
                          if (!_isPhoneValid)
                            Padding(
